...
![base component hierarchy](../team/images/ComponentsBase.png)
...
![class diagram](../team/images/serverclasses.png )
...
![components1](../team/images/ComponentsSprint1.png)
...
In this sprint, we will be adding UI elements for these epics: Find Places #63

#### Find Places
This epic requires a search bar to find places in the database. We will add that search bar in the map window as shown below.
![find_places](../team/images/sprint2/find_places.png)

### Client Components

For this sprint, we will add 5 new components to Map.js.
* SearchBar.js will contain the UI element outlined in the Find Places epic

![sprint2diagram](../team/images/sprint2/components.png)

### Server Classes

In this sprint we have to add a FindRequest class and a Database package with Credential, Database, and Find classes to assist with easy access to the database.

![uml](../team/images/sprint2/uml.png)

# Sprint 3

### User Interface

In this sprint we will be adding UI elements for the Distances(#73), Load Trip(#), Save Trip(#182), and Trip Name(#183).

#### Distances
This epic requres the distances between locations and total distances are displayed on the trip table
![distances](../team/images/sprint3/distances.png)

#### Load Trip
This epic requires a button that allows a user to load a trip from a file.
![load_trip](../team/images/sprint3/loadTrip.png)

#### Save Trip
This epic requires a button that allows a user to save a trip to local storage.
![save_trip](../team/images/sprint3/saveTrip.png)

### Client Components
No changes to client components.

### Server Classes
Adding DistanceRequest.java, TestDistanceRequest.java, and CalculateDistance.java

![uml](../team/images/sprint3/uml.png)
...
#### Shorter Trip
Add button to optimize current trip
![tour](../team/images/sprint4/tour.png)

### Client Components
No new components

### Server Classes
![uml](../team/images/sprint4/uml.png)
...
#### Find
![find](../team/images/sprint5/find.png)
#### Distances
![distance](../team/images/sprint5/distance.png)
#### Trip Name
![trip_name](../team/images/sprint5/trip_name.png)
#### Highlight place
![highlight_place](../team/images/sprint5/trip_name.png)

### Server Classes
![uml](../team/images/sprint5/uml.png)
